...
const Features = () => {
    return (
        <div id='features' className='my-5'>
            <h1 className='my-5 py-3'
            >Life @ Senior Care Home</h1>
            <div className="row mx-5">
                <div className="col-md-3 col-sm-6 col-12">
                    <div className='mx-3'>
                        <i class="fas fa-phone-volume fs-1 bg-info p-4 rounded-circle"></i>
                ...
                <div className="col-md-3 col-sm-6 col-12">
                    <div className='mx-3'>
                        <i class="fas fa-user-md fs-1 bg-info p-4 rounded-circle"></i>
                ...
                <div className="col-md-3 col-sm-6 col-12">
                    <div className='mx-3'>
                        <i class="fas fa-running fs-1 bg-info p-4 rounded-circle"></i>
                ...
                <div className="col-md-3 col-sm-6 col-12">
                    <div className='mx-3'>
                        <i class="fas fa-hand-holding-heart fs-1 bg-info p-4 rounded-circle"></i>
